...
async function getIsraelGeneralData() {
    ...
    try {
        return generalData = {
            date: dateFormat(dataGeneralInfected.date),
            confirmed: dataGeneralInfected.sum.toLocaleString(),
            newSick: dataGeneralInfected.amount.toLocaleString(),
            totalVaccinated: dataGeneralVaccinated.vaccinated_cum.toLocaleString(),
            vacciPopuPerc: dataGeneralVaccinated.vaccinated_population_perc + "%",
            totalVacc2nd: dataGeneralVaccinated.vaccinated_seconde_dose_cum.toLocaleString(),
            totalVacc3rd: dataGeneralVaccinated.vaccinated_third_dose_cum.toLocaleString(),
        }
        //   "                   Date: " + dataGeneralInfected.date+ "\n" +
...
function getIsraelCityData(cityData) {
    try {
        ...
        return cityData = {
            name: cityData.name,
            activeSick: cityData.activeSick,
            color: cityData.color,
            firstDose: cityData.firstDose + "%",
            secondDose: cityData.secondDose + "%",
            thirdDose: cityData.thirdDose + "%",

        }
        //   "               City: " + reverse(cityData.name)+ "\n" +
